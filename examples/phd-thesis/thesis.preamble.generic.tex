...
\newcommand{\hyperrefDoiWithPathXX}[2]{%
	~{\footnotesize \textsf{DOI: }}\hyperrefDoi{#1}{hyperdoi}~{\footnotesize \textsf{[path: \texttt{\detokenize{#2}}]}}%
}
\newcommand{\hyperrefDoiWithPath}[2]{%
	\hyperrefDoi{#1}{hyperdoi}~{\footnotesize \textsf{[path: \texttt{\detokenize{#2}}]}}%
}

% Blank page for cleardoublepage
...
\newcommand{\cleardoublepageforprint}{%
	\ifprintversion
		\cleardoublepage
	\else
		\clearpage
...
\newcommand{\cleardoublepageforprintblank}{%
	\ifprintversion
